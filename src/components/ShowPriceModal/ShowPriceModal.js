...
import ImageOne from "../ShowPriceModal/images/staticmap.jpg"

const ShowPriceModal = ({ setIsOpen }) => {
            ...
            <div className="modal-centered">
                <div className="main-modal">
                    <div className="modalHeader-container">
                        <h2 className="venue-heading">One World Hotel</h2>
                        <div>
                    ...
                    <div className="modalContent-container">
                        ...
                        <h2 className="Contact-Info">Price Information</h2>
                        ...
                        <div className="price-map-container">
                            ...
                            <div className="map-overlay">
                                <button className="Map-view-btn">
                                    ...
                                    <Link  to="/destination"><p>Map View</p></Link>
                                </button>
                            </div>
                        </div>
                        <div className="rating-rating-icon-container">
                            <p className="property-strength">8.7 Fabulous</p>
                        ...
                        <div className="price-info">
                            <h1 className="Price-tag">$1,100 per Adult</h1>
                        </div>

                        <div className="distance-of-location">
                            <div className="location-svg">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em" viewBox="0 0 24 24" fill="#0068EF"><path d="M15 8.25a3 3 0 1 1-6 0 3 3 0 0 1 6 0zm1.5 0a4.5 4.5 0 1 0-9 0 4.5 4.5 0 0 0 9 0zM12 1.5a6.75 6.75 0 0 1 6.75 6.75c0 2.537-3.537 9.406-6.75 14.25-3.214-4.844-6.75-11.713-6.75-14.25A6.75 6.75 0 0 1 12 1.5zM12 0a8.25 8.25 0 0 0-8.25 8.25c0 2.965 3.594 9.945 7 15.08a1.5 1.5 0 0 0 2.5 0c3.406-5.135 7-12.115 7-15.08A8.25 8.25 0 0 0 12 0z"></path></svg>
                            </div>
                            <p>6.7 km from center</p>
                        </div>
