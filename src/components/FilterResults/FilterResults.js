        ...
        <div className="Parent-main-filter-result-container">
            <div className="Sub-parent-main-filter-result-container">
                ...
                <div className="Filtered-result">
                    ...
                    <div className={`location-general-container-one  ${button2Active ? 'gridChange' : 'Button 2'}`}>
                        <FilterLocation />
                        <FilterLocation />
                        <FilterLocation />
                        <FilterLocation />
