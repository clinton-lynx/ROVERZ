...
const Items = () => {
  ...
  return (
    <div className="general-items-container" id="general-items-diplay">
      <Slider {...settings}>
        <div>
          <SubItems name="Amenities" />
        </div>
        <div>
          <SubItems name="Hotels" />
        </div>
        <div>
          <SubItems name="Resturrants" />
        </div>
        <div>
          <SubItems name="Malls" />
        </div>
        <div>
          <SubItems name="Event Places" />
        </div>
        <div>
          <SubItems name="Cinemas" />
        </div>
        {/* <div>
            <SubItems />
            </div>
...
const SubItems = (props) => {
  return (
    <Link className="subitems-container"  to="/result">
